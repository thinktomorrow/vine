...
{
    /** @test */
    function it_can_sort_collection_of_array_entries()
    {
    ...
    /** @test */
    function it_can_sort_collection_of_object_entries()
    {
        $collection = new NodeCollection(
    ...
    /** @test */
    function it_can_call_sort_on_a_node()
    {
    ...
    /** @test */
    function it_can_sort_nested_collection()
    {
        $collection = new NodeCollection(
    ...
    /** @test */
    function if_sorting_key_does_not_exist_unsorted_entries_are_expected()
    {
        $original = new Node((object)['id' => 2]);
        $original->addChildren([new Node(['id' => '23']), new Node(['id' => '22']), new Node(['id' => '21'])]);
